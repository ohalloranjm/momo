...
The `/newpc` slash command creates a new player character (PC) and makes it your active character.
...
If you’ve already created the maximum of five player characters, Momo will prompt you to delete one and try again.
...
Once you choose a stat to increase, Momo will save your PC to its database and tell you that your character was created successfully. The newly created PC is now your active PC.
