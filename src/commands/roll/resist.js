  ...
  data: new SlashCommandBuilder()
    ...
    .addIntegerOption(option =>
      option
        .setName('modifier')
        .setDescription(
          'A number to add to your roll, or a negative number to subtract from it (conditions are auto-applied)'
        )
    ),
  async execute(interaction) {
    await interaction.reply(
      new Roll('resist shifting your balance')
        ...
        .appendText(
          'miss',
          'They know just what to say to throw you off balance. Mark a condition, and the GM shifts your balance twice.'
        )
